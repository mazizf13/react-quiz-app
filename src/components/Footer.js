...
const Footer = ({ display, handleStart }) => {
  ...
  return (
    <div className="bg-dark w-full flex justify-between items-center px-4 py-2 sm:px-8 sm:py-4 text-white font-urbanist">
      <div className="flex gap-4 cursor-pointer">
        <svg
          onClick={handleOpenModal}
          className="bg-dark rounded-full fill-primary hover:border-white hover:scale-110 hover:shadow-2xl hover:fill-white"
        ...
        {display !== "start" && (
          <svg
            onClick={handleStart}
            className="bg-dark border-[4px] sm:border-[6px] border-primary rounded-full fill-primary hover:border-white hover:scale-110 hover:shadow-2xl hover:fill-white"
            xmlns="http://www.w3.org/2000/svg"
            width="48"
            height="48"
            viewBox="0 0 64 64"
      ...
      <div className="text-sm sm:text-lg md:text-xl text-primary font-urbanist">
        created by:{" "}
        <span>
          <a
            href="https://github.com/mazizf13/react-quiz-app"
            target="_blank"
            rel="noreferrer"
          >
            @aztyc
